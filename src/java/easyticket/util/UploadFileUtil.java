...
public class UploadFileUtil {
    ...
    public static String upload(HttpServletRequest request, String paramName, String fileName) {
        ...
        filePath = File.separator + File.separator + "data" + File.separator + File.separator;
        filePath += "webhome" + File.separator + File.separator + "thuoc.net";
        filePath += File.separator + File.separator + "upload" + File.separator + File.separator;
        filePath += "images" + File.separator;

//        filePath = "C:\\Users\\S400\\Documents\\NetBeansProjects\\thoitiet\\web\\resources\\upload\\image" + File.separator;
...
//        filePath = File.separator + File.separator + "data" + File.separator + File.separator;
//        filePath += "webhome" + File.separator + File.separator + "thoitiet.com.vn";
//        filePath += File.separator + File.separator + "upload" + File.separator + File.separator;
//        filePath += "images" + File.separator;
...
//        filePath = "E:"+File.separator;
        ...
        filePath = path + File.separator + "\\upload\\images\\"+File.separator+forder+File.separator;
