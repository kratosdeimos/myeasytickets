package easyticket.database;

import easyticket.constants.Constants;
...
public class DBPoolX {
    ...
    public static void init() throws Exception {
        try {
            ...
            properties.load(DBPoolX.class.getResourceAsStream("/easyticket/configuration/dbpool.properties"));
...
//        System.out.println(Encrypter.decrypt("/4U8i3Dg+Ts="));
//        System.out.println(Encrypter.encrypt("softsms"));
